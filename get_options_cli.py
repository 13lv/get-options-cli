...
#       <short option>: (<variable name>, <regex option value>)
        ...
        '-a': ('a_var', r'^[A-z]{10,255}$'),
        '--along': ('along_var', r'^[A-z]{10,255}$'),
        '-b': ('b_var', r'^[A-z]{10,255}$'),
        '--blong': ('blong_var', r'^[A-z]{10,255}$'),
        '-c': ('c_var', r'^[A-z]{10,255}$'),
        '--clong': ('clong_var', r'^[A-z]{10,255}$'),

        '-d': ('d_var', r'^[A-z]{10,255}$'),
        '--dlong': ('dlong_var', r'^[A-z]{10,255}$'),
        '-e': ('e_var', r'^[A-z]{10,255}$'),
        '--elong': ('elong_var', r'^[A-z]{10,255}$'),
        '-f': ('f_var', r'^[A-z]{10,255}$'),
        '--flong': ('flong_var', r'^[A-z]{10,255}$'),
    }
